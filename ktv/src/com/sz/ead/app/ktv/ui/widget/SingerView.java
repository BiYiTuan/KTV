...
public class SingerView extends RelativeLayout
{
	...
	private void init()
	{
		inflate(mContext, R.layout.view_singer, this);
		mIcon = (ImageView) findViewById(R.id.id_singer_icon);
		mName = (TextView) findViewById(R.id.id_singer_name);
	}
	...
	{
		ImageLoaderUtils.mImageLoader.displayImage(url, mIcon, ImageLoaderUtils.mSingerOption);
	}
