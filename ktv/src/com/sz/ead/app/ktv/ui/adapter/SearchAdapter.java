...
public class SearchAdapter extends BaseAdapter 
{
	...
	public SearchAdapter(Context context, ArrayList<Video> list, ListView lv) 
	{
		mSearchList = list;
		mContext = context;
		mListView = lv;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if (convertView == null) 
		{
			...
			mHolder.mName = (TextView) convertView.findViewById(R.id.id_search_result_name);
			mHolder.mPlay = (ImageView) convertView.findViewById(R.id.id_search_result_play);
			mHolder.mAdd = (ImageView) convertView.findViewById(R.id.id_search_result_add);
			mHolder.mCollect = (ImageView) convertView.findViewById(R.id.id_search_result_collect);
